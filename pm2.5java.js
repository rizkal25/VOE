...
function updateIconColor(value) {
    ...
    var text3 = document.getElementById("prediction-text-3");
     ...
     [icon1, icon2, icon3].forEach(icon => {
        icon.classList.remove("blue", "green", "flashing");
    });
    ...
    if (value === 1) {
        icon1.classList.add("blue", "flashing"); // Setel ikon 1 menjadi biru
        icon2.classList.add("green"); // Setel ikon 2 menjadi hijau
        icon3.classList.add("green"); // Setel ikon 3 menjadi hijau
        text1.textContent = 'Predt 1';

    } else if (value === 2) {
        icon1.classList.add("blue", "flashing"); // Setel ikon 1 menjadi biru
        icon2.classList.add("blue", "flashing"); // Setel ikon 2 menjadi biru
        icon3.classList.add("green", "flashing"); // Setel ikon 3 menjadi hijau
        text2.textContent = 'Predt 2';
    } else if (value === 3) {
        icon1.classList.add("blue", "flashing"); // Setel ikon 1 menjadi biru
        icon2.classList.add("blue", "flashing"); // Setel ikon 2 menjadi biru
        icon3.classList.add("blue", "flashing"); // Setel ikon 3 menjadi biru
...
function drawPM25Histogram(data) {
    ...
    data.forEach(entry => {
        ...
        else if (value >= 51 && value <= 100) ranges['31-60']++;
        else if (value >= 101 && value <= 150) ranges['61-100']++;
        else if (value >= 151 && value <= 200) ranges['101-200']++;
            ...
            options: {
                ...
                scales: {
                    xAxes: [{
                        scaleLabel: {
                            display: true,
                            labelString: 'Rentang Kadar PM2.5 (µg/m³)'
                        }
                    }],
                    yAxes: [{
                        scaleLabel: {
